...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(19122), AOM_ICDF(21289), AOM_ICDF(22680), AOM_ICDF(22995),
  AOM_ICDF(23253), AOM_ICDF(26996), AOM_ICDF(27859), AOM_ICDF(28611),
  AOM_ICDF(28854), AOM_ICDF(29215), AOM_ICDF(29826), AOM_ICDF(30952),
  AOM_ICDF(31434), AOM_ICDF(32109), AOM_ICDF(32431), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(421),   AOM_ICDF(1345),  AOM_ICDF(1720),  AOM_ICDF(2586),
  AOM_ICDF(3698),  AOM_ICDF(5688),  AOM_ICDF(6795),  AOM_ICDF(10309),
  AOM_ICDF(11869), AOM_ICDF(16557), AOM_ICDF(17699), AOM_ICDF(23571),
  AOM_ICDF(24257), AOM_ICDF(27104), AOM_ICDF(28865), AOM_ICDF(32768)
};
#endif
