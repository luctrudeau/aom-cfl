...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(17593), AOM_ICDF(19824), AOM_ICDF(21294), AOM_ICDF(21548),
  AOM_ICDF(21777), AOM_ICDF(26409), AOM_ICDF(27502), AOM_ICDF(28131),
  AOM_ICDF(28398), AOM_ICDF(28761), AOM_ICDF(29429), AOM_ICDF(30771),
  AOM_ICDF(31307), AOM_ICDF(32005), AOM_ICDF(32386), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(472),   AOM_ICDF(1593),  AOM_ICDF(1995),  AOM_ICDF(2968),
  AOM_ICDF(4316),  AOM_ICDF(6672),  AOM_ICDF(7810),  AOM_ICDF(11837),
  AOM_ICDF(13211), AOM_ICDF(18528), AOM_ICDF(19571), AOM_ICDF(25194),
  AOM_ICDF(25890), AOM_ICDF(28325), AOM_ICDF(30065), AOM_ICDF(32768)
};
#endif
