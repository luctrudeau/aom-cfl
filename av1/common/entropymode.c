...
#if CONFIG_CFL
static const aom_cdf_prob default_cfl_alpha_u_cdf[CDF_SIZE(CB_ALPHABET_SIZE)] =
    { AOM_ICDF(7308),  AOM_ICDF(12226), AOM_ICDF(18479), AOM_ICDF(23179),
      AOM_ICDF(26872), AOM_ICDF(29229), AOM_ICDF(30555), AOM_ICDF(31337),
      AOM_ICDF(32135), AOM_ICDF(32372), AOM_ICDF(32504), AOM_ICDF(32573),
      AOM_ICDF(32615), AOM_ICDF(32647), AOM_ICDF(32668), AOM_ICDF(32768) };

static const aom_cdf_prob default_cfl_alpha_v_cdf[CDF_SIZE(CR_ALPHABET_SIZE)] =
    { AOM_ICDF(11694), AOM_ICDF(18689), AOM_ICDF(24465), AOM_ICDF(27601),
      AOM_ICDF(29489), AOM_ICDF(30569), AOM_ICDF(31169), AOM_ICDF(31520),
      AOM_ICDF(32004), AOM_ICDF(32179), AOM_ICDF(32370), AOM_ICDF(32483),
      AOM_ICDF(32546), AOM_ICDF(32590), AOM_ICDF(32621), AOM_ICDF(32768) };
#endif
