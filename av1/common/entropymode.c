...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(17408), AOM_ICDF(19456), AOM_ICDF(20864), AOM_ICDF(21120),
  AOM_ICDF(21248), AOM_ICDF(27008), AOM_ICDF(28288), AOM_ICDF(28544),
  AOM_ICDF(28672), AOM_ICDF(28928), AOM_ICDF(29568), AOM_ICDF(30848),
  AOM_ICDF(31360), AOM_ICDF(32000), AOM_ICDF(32384), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(640),   AOM_ICDF(2176),  AOM_ICDF(2688),  AOM_ICDF(3840),
  AOM_ICDF(5760),  AOM_ICDF(8448),  AOM_ICDF(9472),  AOM_ICDF(14208),
  AOM_ICDF(15360), AOM_ICDF(20736), AOM_ICDF(21760), AOM_ICDF(26368),
  AOM_ICDF(27136), AOM_ICDF(29440), AOM_ICDF(30976), AOM_ICDF(32768)
};
#endif
