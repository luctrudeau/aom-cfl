...
static const aom_cdf_prob default_cfl_angle_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18584), AOM_ICDF(20296), AOM_ICDF(21518), AOM_ICDF(22603),
  AOM_ICDF(23484), AOM_ICDF(25256), AOM_ICDF(26054), AOM_ICDF(27421),
  AOM_ICDF(27994), AOM_ICDF(28968), AOM_ICDF(29545), AOM_ICDF(30548),
  AOM_ICDF(31082), AOM_ICDF(31815), AOM_ICDF(32321), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(71), AOM_ICDF(298), AOM_ICDF(390), AOM_ICDF(638),
  AOM_ICDF(964), AOM_ICDF(1568), AOM_ICDF(2212), AOM_ICDF(3532),
  AOM_ICDF(4687), AOM_ICDF(6926), AOM_ICDF(8342), AOM_ICDF(12259),
  AOM_ICDF(13426), AOM_ICDF(18263), AOM_ICDF(22351), AOM_ICDF(32768)
};
#endif
