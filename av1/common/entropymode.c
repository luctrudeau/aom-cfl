...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(17283), AOM_ICDF(19261), AOM_ICDF(20625), AOM_ICDF(20866),
  AOM_ICDF(21084), AOM_ICDF(26402), AOM_ICDF(27679), AOM_ICDF(28179),
  AOM_ICDF(28421), AOM_ICDF(28783), AOM_ICDF(29435), AOM_ICDF(30806),
  AOM_ICDF(31335), AOM_ICDF(32007), AOM_ICDF(32387), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(531),   AOM_ICDF(1740),  AOM_ICDF(2084),  AOM_ICDF(3043),
  AOM_ICDF(4573),  AOM_ICDF(6883),  AOM_ICDF(7972),  AOM_ICDF(12164),
  AOM_ICDF(13451), AOM_ICDF(18998), AOM_ICDF(20012), AOM_ICDF(25457),
  AOM_ICDF(26177), AOM_ICDF(28527), AOM_ICDF(30363), AOM_ICDF(32768)
};
#endif
