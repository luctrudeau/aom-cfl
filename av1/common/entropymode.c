...
static const aom_cdf_prob default_cfl_alpha_u_cdf[CDF_SIZE(16)] = {
  AOM_ICDF(11068), AOM_ICDF(15203), AOM_ICDF(20878), AOM_ICDF(24690),
  AOM_ICDF(27884), AOM_ICDF(29918), AOM_ICDF(30965), AOM_ICDF(31554),
  AOM_ICDF(32284), AOM_ICDF(32468), AOM_ICDF(32565), AOM_ICDF(32611),
  AOM_ICDF(32643), AOM_ICDF(32663), AOM_ICDF(32677), AOM_ICDF(32768)
};

static const aom_cdf_prob default_cfl_alpha_v_cdf[CDF_SIZE(16)] = {
  AOM_ICDF(15379), AOM_ICDF(21022), AOM_ICDF(26089), AOM_ICDF(28558),
  AOM_ICDF(30152), AOM_ICDF(31008), AOM_ICDF(31461), AOM_ICDF(31724),
  AOM_ICDF(32161), AOM_ICDF(32284), AOM_ICDF(32448), AOM_ICDF(32538),
  AOM_ICDF(32585), AOM_ICDF(32615), AOM_ICDF(32634), AOM_ICDF(32768)
};
#endif
