...
static const aom_cdf_prob default_cfl_alpha_cdf[CFL_ALPHA_CDF_SIZE] = {
  ...
  */
  ...
  /*
  6365,  10006, 10617, 10684, 16975, 21889, 23107, 23270, 25071,
  28281, 30458, 31029, 31223, 31563, 32321, 32768
  */
  // 1D Quant (from notebook + cheating on 0)
  /*
  6787, 9540, 10011, 10063, 14790, 21734, 23092, 23270, 24669, 28281, 30458,
  31029, 31179, 31563, 32321, 32768
  */
  // 2D Quant (from notebook)
  /*
  6506,  12317, 13979, 14324, 20293, 23949, 25076, 25716,
  28110, 30214, 31016, 31146, 32015, 32548, 32754, 32768,
  */
  /*
  // 2D Quant (from notebook + cheating on 0)
  6509,  13553, 15291, 15740, 19828, 24084, 25250, 25646, 28028,
  ...
  */
  // Rotated coordinates, 2 iterations of RD-optimal alpha choice
  13415, 15692, 20153, 21277, 22110, 25519, 26693, 28789, 29362,
  29880, 30618, 31394, 31972, 32194, 32596, 32768
