...
static const aom_cdf_prob default_cfl_angle_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(17860), AOM_ICDF(20052), AOM_ICDF(21531), AOM_ICDF(22338),
  AOM_ICDF(23033), AOM_ICDF(25663), AOM_ICDF(26399), AOM_ICDF(27847),
  AOM_ICDF(28213), AOM_ICDF(29036), AOM_ICDF(29668), AOM_ICDF(30718),
  AOM_ICDF(31233), AOM_ICDF(31987), AOM_ICDF(32420), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(53), AOM_ICDF(280), AOM_ICDF(348), AOM_ICDF(587),
  AOM_ICDF(934), AOM_ICDF(1541), AOM_ICDF(2098), AOM_ICDF(3429),
  AOM_ICDF(4529), AOM_ICDF(6797), AOM_ICDF(8058), AOM_ICDF(12531),
  AOM_ICDF(13425), AOM_ICDF(18061), AOM_ICDF(21667), AOM_ICDF(32768)
};
#endif
