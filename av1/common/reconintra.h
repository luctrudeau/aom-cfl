...
static const double cfl_alpha_codes[CFL_MAX_ALPHA_IND][2] = {
  ...
  */
  ...
  { 1.623431, -0.540909 }
  */
  // k-means but for minimizing rate-distortion cost, trained on subset1
  { 0.0,    0.0   }, { 0.071, 0.0   }, { 0.113, -0.071 }, { 0.178,  0.0 },
  { 0.228,  0.114 }, { 0.21, -0.126 }, { 0.316,  0.0   }, { 0.322, -0.2 },
  { 0.5,    0.0   }, { 0.6,   0.315 }, { 0.434, -0.335 }, { 0.572, -0.2 },
  { 0.642, -0.457 }, { 0.95,  0.0   }, { 1.0,   -0.6   }, { 2.0,   -0.6 }
