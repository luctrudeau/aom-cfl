...
static const double cfl_alpha_codes[CFL_MAX_ALPHA_IND][2] = {
  ...
  */
  ...
  { 1.373512, 2.382514 }
  */
  // barrbrain's 1D quant trained on kodim
  { 0., 0. },       { 0.204, 0. }, { 0.204, 0.204 },
  { 0., 0.204 },    { 0.528, 0. }, { 0.528, 0.204 },
  { 0.528, 0.528 }, { 0., 0.528 }, { 1.495, 1.495 },
  { 0.204, 0.528 }, { 1.495, 0. }, { 0.528, 1.495 },
  { 1.495, 0.528 }, { 0., 1.495 }, { 1.495, 0.204 },
  { 0.204, 1.495 }
